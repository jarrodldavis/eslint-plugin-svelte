...
const DIRECTIVE_KEYS = [EXPRESSION_KEY, "name"];
...
const BASE_TEMPLATE_KEYS = {
  ...
  InlineComponent: [...ELEMENT_KEYS, EXPRESSION_KEY, "name"],
  ...
  // tag: directives
  Action: DIRECTIVE_KEYS,
  Animation: DIRECTIVE_KEYS,
  Binding: DIRECTIVE_KEYS,
  Class: DIRECTIVE_KEYS,
  EventHandler: DIRECTIVE_KEYS,
  Let: DIRECTIVE_KEYS,
  Ref: DIRECTIVE_KEYS,
  Transition: DIRECTIVE_KEYS,
